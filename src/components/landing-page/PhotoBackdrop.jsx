...
export default function PhotoBackdrop({ deepen = false }) {
  ...
  return (
    <m.div className="absolute inset-0 overflow-hidden" aria-hidden="true"
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-background via-background/75 via-40% to-background/10 md:via-background/55 md:via-35% md:to-background/25" />
